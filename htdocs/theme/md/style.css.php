...
.picturewarning, .pictureerror, .picturepreview, .picturenopreview {
	padding-<?php echo $left; ?>: 3px;
}
.picturewarning {
	/* vertical-align: text-bottom; */
...
img.hideonsmartphone.pictureactionview {
	vertical-align: bottom;
}
...
/* Text of picture visible on hover, for the picture only */
...
td.widthpicturetitle, .table-fiche-title img.widthpicturetitle { width: 32px; font-size: 1.4em; text-align: <?php echo $left; ?>; }
