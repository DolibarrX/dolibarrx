...
print dol_get_fiche_head($head, 'productMargins', $titre, 0, $picture);
...
print img_picture('', 'product', 'class="picturefixedwidth"').$form->select_produits(($id > 0 ? $id : ''), 'id', '', 20, 0, 1, 2, '', 1, array(), 0, '', 0, '', 0, '', null, 1);
print '</td></tr>';
