...
class ConferenceOrBoothAttendee extends CommonObject
{
	...
	public $fields = array(
		...
		'fk_invoice' => array('type' => 'integer:Invoice:compta/invoice/class/invoice.class.php', 'label' => 'Invoice', 'enabled' => 'isModEnabled("invoice")', 'position' => 57, 'notnull' => 0, 'visible' => 1, 'index' => 0, 'picture' => 'bill', 'css' => 'maxwidth500 widthcentpercentminusxx', 'csslist' => 'tdoverflowmax150'),
