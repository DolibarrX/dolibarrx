...
print '<tr>';
print '<td>';
print '<button type="submit" name="anneeavant" value="<<">'.img_picture($langs->trans("PreviousYear"), 'chevron-double-left', 'class="double"').'</button>';
//print '<input type="image" class="buttonwebsite" name="anneeavant" value="<<" src="../img/rewind.png">';
print '</td>';
print '<td>';
print '<button type="submit" name="moisavant" value="<">'.img_picture($langs->trans("PreviousMonth"), 'chevron-left', 'class="double"').'</button>';
...
//print '<input type="image" name="retourmois" class="buttonreset" alt="'.dol_escape_htmltag($langs->trans("BackToCurrentMonth")).'" title="'.dol_escape_htmltag($langs->trans("BackToCurrentMonth")).'" value="" src="'.img_picture('', 'refresh', '', 0, 1).'">';
print '</td>';
print '<td>';
print '<button type="submit" name="moisapres" value=">">'.img_picture($langs->trans("NextMonth"), 'chevron-right', 'class="double"').'</button>';
//print '<input type="image" class="buttonwebsite" name="moisapres" value=">" src="../img/next.png">';
print '</td>';
print '<td>';
print '<button type="submit" name="anneeapres" value=">>">'.img_picture($langs->trans("NextYear"), 'chevron-double-right', 'class="double"').'</button>';
