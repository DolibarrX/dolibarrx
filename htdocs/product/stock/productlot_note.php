...
$diroutputmassaction = $config->productlot->dir_output.'/temp/massgeneration/'.$user->id;
...
if ($id > 0 || !empty($ref)) {
	$upload_dir = $config->productlot->multidir_output[!empty($object->entity) ? $object->entity : $config->entity]."/".$object->id;
}
...
//if (empty($config->calibration->enabled)) accessforbidden();
