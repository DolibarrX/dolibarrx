...
if ($action == 'create') {
	...
	print load_fiche_titre($langs->trans("NewObject", $langs->transnoentitiesnoconv("Target")), '', 'object_'.$object->picture);
...
if (($id || $ref) && $action == 'edit') {
	print load_fiche_titre($langs->trans("Target"), '', 'object_'.$object->picture);
...
if ($object->id > 0 && (empty($action) || ($action != 'edit' && $action != 'create'))) {
	...
	print dol_get_fiche_head($head, 'card', $langs->trans("Target"), -1, $object->picture);
