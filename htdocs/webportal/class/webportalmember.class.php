 ...
 */
class WebPortalMember extends Member
{
	/**
	...
	const ARRAY_STATUS_LABEL = array(
		Member::STATUS_DRAFT => 'Draft',
		Member::STATUS_VALIDATED => 'Validated',
		Member::STATUS_RESILIATED => 'MemberStatusResiliatedShort',
		Member::STATUS_EXCLUDED => 'MemberStatusExcludedShort',
	);
	...
	/**
	 * @var Member Member for static methods
	 */
	...
	public $fields = array(
		...
		'typeid' => array('type' => 'integer:MemberType:members/class/member_type.class.php', 'label' => 'MemberType', 'enabled' => 1, 'visible' => 4, 'notnull' => 1, 'position' => 255),
	...
	{
		global $config, $langs, $form, $extralanguages;
