...
/**
 *      \file       htdocs/fourn/invoice/note.php
 *      \ingroup    invoice
 *      \brief      Fiche de notes sur une invoice fournisseur
 */
...
// Set label
if ($action == 'setlabel' && ($user->hasRight("fournisseur", "invoice", "creer") || $user->hasRight("supplier_invoice", "creer"))) {
...
llxHeader('', $title, $helpurl, '', 0, 0, '', '', '', 'mod-fourn-invoice page-card_note');
