...
/**
 *  \file       htdocs/fourn/invoice/messaging.php
 *  \ingroup    invoice
...
$diroutputmassaction = $config->invoice->multidir_output[$config->entity].'/temp/massgeneration/'.$user->id;
...
if ($id > 0 || !empty($ref)) {
	$upload_dir = $config->invoice->multidir_output[!empty($object->entity) ? $object->entity : $config->entity]."/".$object->id;
}

$permissiontoread = $user->hasRight("invoice_fourn", "lire");
$permissionToAdd = $user->hasRight("invoice_fourn", "creer");
