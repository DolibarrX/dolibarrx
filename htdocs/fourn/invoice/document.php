...
/**
 *       \file       htdocs/fourn/invoice/document.php
...
if ($object->fetch($id, $ref)) {
	...
	$upload_dir = $config->fournisseur->invoice->dir_output.'/'.get_exdir($object->id, 2, 0, 0, $object, 'invoice_supplier').$ref;
}

$permissionToAdd = ($user->hasRight("fournisseur", "invoice", "creer") || $user->hasRight("supplier_invoice", "creer")); // Used by the include of actions_setnotes.inc.php
...
llxHeader('', $title, $helpurl, '', 0, 0, '', '', '', 'mod-fourn-invoice page-card_document');
...
if ($object->id > 0) {
	...
	*/
	...
	$permission = ($user->hasRight("fournisseur", "invoice", "creer") || $user->hasRight("supplier_invoice", "creer"));
	$permtoedit = ($user->hasRight("fournisseur", "invoice", "creer") || $user->hasRight("supplier_invoice", "creer"));
