...
/**
 *	\file		htdocs/fourn/invoice/index.php
*	\ingroup	invoice
...
// Security check
restrictedArea($user, 'fournisseur', 0, '', 'invoice');
...
llxHeader("", $langs->trans("SupplierInvoicesArea"), 'EN:Suppliers_Invoices|FR:InvoiceSupplier|ES:Facturas_de_proveedores');
