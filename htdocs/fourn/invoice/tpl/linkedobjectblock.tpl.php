...
print "<!-- BEGIN PHP TEMPLATE fourn/invoice/tpl/linkedobjectblock.tpl.php -->\n";
...
foreach ($linkedObjectBlock as $key => $objectlink) {
	...
	<tr class="<?php echo $trclass; ?>">
		...
		<td><a href="<?php echo DOL_URL_ROOT.'/fourn/invoice/card.php?facid='.$objectlink->id ?>"><?php echo img_object($langs->trans("ShowBill"), "bill").' '.$objectlink->ref; ?></a></td>
