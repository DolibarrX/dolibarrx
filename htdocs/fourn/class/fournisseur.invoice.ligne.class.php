...
/**
 *  \file       htdocs/fourn/class/fournisseur.invoice.ligne.class.php
...
class SupplierInvoiceLine extends CommonObjectLine
{
	 ...
	 */
	public $element = 'invoice_fourn_det';

	/**
	 * @var string Name of table without prefix where object is stored
	 */
	public $table_element = 'invoice_fourn_det';

	/**
	 * @see CommonObjectLine
	 */
	public $parent_element = 'invoice_fourn';

	/**
	 * @see CommonObjectLine
	 */
	public $fk_parent_attribute = 'fk_invoice_fourn';
	 ...
	 * TODO Rename field ref to ref_supplier into table llx_invoice_fourn_det and llx_order_fournisseurdet and update fields into updateline
	 * @var string
	 */
	public $ref_supplier;
	...
	public function fetch($rowid)
	{
		...
		$sql .= ', f.total_ht, f.tva as total_tva, f.total_ttc, f.fk_invoice_fourn, f.fk_product, f.product_type, f.info_bits, f.rang, f.special_code, f.fk_parent_line, f.fk_unit';
		...
		$this->fk_invoice_fourn = $obj->fk_invoice_fourn;
	...
	public function delete($notrigger = 0)
	{
		...
		if (!$error) {
			// Supprime ligne
			$sql = 'DELETE FROM '.MAIN_DB_PREFIX.'invoice_fourn_det ';
	...
	public function update($notrigger = 0)
	{
		...
		$sql = "UPDATE ".MAIN_DB_PREFIX."invoice_fourn_det SET";
	...
	public function insert($notrigger = 0, $noerrorifdiscountalreadylinked = 0)
	{
		...
		$sql .= ' (fk_invoice_fourn, fk_parent_line, label, description, ref, qty,';
		...
		$sql .= ')';
		$sql .= " VALUES (".$this->fk_invoice_fourn.",";
		...
		if ($resql) {
			...
			// Si If fk_remise_except is set, the discount is linked to the invoice
	...
	public function update_total()
	{
		...
		dol_syslog("InvoiceSupplierLigne.class.php::update_total", LOG_DEBUG);
