...
/**
 *	\file       htdocs/fourn/invoice/class/fournisseur.invoice-rec.ligne.class.php
 *	\ingroup    invoice
 ...
 *  Saved into database table llx_invoice_fourn_det_rec
 */
class InvoiceSupplierLigneRec extends CommonInvoiceLine
{
	/**
	 ...
	 */
	public $table_element = 'invoice_fourn_det_rec';
	...
	{
		$sql = 'SELECT l.rowid,';
		$sql .= ' l.fk_invoice_fourn, l.fk_parent_line, l.fk_product,';
		...
		if ($result) {
			...
			$this->id                       = $objp->rowid;
			$this->fk_invoice_fourn         = $objp->fk_invoice_fourn;
	...
	public function update(User $user, $notrigger = 0)
	{
		...
		$sql .= ' fk_invoice_fourn = ' . (int) $this->fk_invoice_fourn;
