...
/**
 *      \file       htdocs/contract/admin/contract_extrafields.php
 *		\ingroup    contract
...
$elementtype = 'contractdet'; //Must be the $element of the class that manage extrafield
...
llxHeader('', $title, $help_url, '', 0, 0, '', '', '', 'mod-contract page-admin_extrafields_lines');
