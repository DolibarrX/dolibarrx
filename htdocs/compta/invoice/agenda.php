...
/**
 *  \file       htdocs/compta/invoice/agenda.php
 *  \ingroup    invoice
...
restrictedArea($user, 'invoice', $object->id, '', '', 'fk_soc', 'rowid', $isdraft);
...
if ($object->id > 0) {
	...
	$messagingUrl = DOL_URL_ROOT.'/compta/invoice/messaging.php?id='.$object->id;
	$morehtmlright .= dolGetButtonTitle($langs->trans('ShowAsConversation'), '', 'fa fa-comments imgforviewmode', $messagingUrl, '', 1);
	$messagingUrl = DOL_URL_ROOT.'/compta/invoice/agenda.php?id='.$object->id;
