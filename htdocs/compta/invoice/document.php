...
/**
 *	\file       htdocs/compta/invoice/document.php
 *	\ingroup    invoice
...
if ($id > 0 || !empty($ref)) {
	if ($object->fetch($id, $ref) > 0) {
		...
		$upload_dir = $config->invoice->multidir_output[$object->entity].'/'.dol_sanitizeFileName($object->ref);
		...
		$modulePart = 'invoice';
		$permissionToAdd = $user->hasRight('invoice', 'creer');
		$permtoedit = $user->hasRight('invoice', 'creer');
		$param = '&id='.$object->id;
