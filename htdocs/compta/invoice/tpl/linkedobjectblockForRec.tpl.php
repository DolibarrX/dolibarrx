...
print "<!-- BEGIN PHP TEMPLATE compta/invoice/tpl/linkedobjectblockForRec.tpl.php -->\n";
...
<tr class="<?php echo $trclass; ?>" >
	...
	<td class="linkedcol-action right"><a class="reposition" href="<?php echo $_SERVER["PHP_SELF"].'?id='.$object->id.'&action=dellink&token='.newToken().'&dellinkid='.$key; ?>"><?php echo img_picture($langs->transnoentitiesnoconv("RemoveLink"), 'unlink'); ?></a></td>
</tr>
	<?php
}
