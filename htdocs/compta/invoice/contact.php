...
/**
 *       \file       htdocs/compta/invoice/contact.php
 *       \ingroup    invoice
...
$result = restrictedArea($user, 'invoice', $object->id);
...
if (empty($resHook)) {
	// Add new contact
	if ($action == 'addcontact' && $user->hasRight('invoice', 'creer')) {
		if ($result > 0 && $id > 0) {
	...
	} elseif ($action == 'swapstatut' && $user->hasRight('invoice', 'creer')) {
		// Toggle the status of a contact
		$result = $object->swapContactStatus(GETPOSTINT('ligne'));
	} elseif ($action == 'deletecontact' && $user->hasRight('invoice', 'creer')) {
		// Delete contact
