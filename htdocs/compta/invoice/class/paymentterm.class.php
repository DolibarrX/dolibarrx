...
class PaymentTerm // extends CommonObject
{
	...
	public function create($user, $notrigger = 0)
	{
		...
		if (isset($this->libelle_invoice)) {
			$this->libelle_invoice = trim($this->libelle_invoice);
		}
		...
		$sql .= " ".(!isset($this->libelle_invoice) ? 'NULL' : "'".$this->db->escape($this->libelle_invoice)."'").",";
	...
	public function fetch($id, $code = '')
	{
		...
		if ($resql) {
			if ($this->db->num_rows($resql)) {
				...
				$this->libelle_invoice = $obj->libelle_invoice;
	...
	public function update($user = null, $notrigger = 0)
	{
		...
		$sql .= " libelle_invoice=".(isset($this->libelle_invoice) ? "'".$this->db->escape($this->libelle_invoice)."'" : "null").",";
