...
/**
 *  \file       htdocs/compta/invoice/agenda-rec.php
 *  \ingroup    invoice
...
restrictedArea($user, 'invoice', $object->id, 'invoice_rec', '', 'fk_soc', 'rowid', $isdraft);
...
if ($object->id > 0) {
	...
	print dol_get_fiche_head($head, 'agenda', $langs->trans("RepeatableInvoice"), -1, $object->picture);
