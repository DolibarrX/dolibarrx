...
if (GETPOST("account") || GETPOST("ref")) {
	...
	$sql .= " WHERE cs.entity = ".$config->entity;
	...
	$sql .= " WHERE sa.entity = ".$config->entity;
	...
	$sql .= " WHERE t.entity = ".$config->entity;
	...
	print_barre_liste($langs->trans("PlannedTransactions"), $page, $_SERVER["PHP_SELF"], $param, $sortfield, $sortorder, $massactionbutton, $num, $nbtotalofrecords, $picture, 0, $morehtml, '', $limit, 0, 0, 1);
