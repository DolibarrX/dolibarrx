...
if (empty($date_start) || empty($date_end)) { // We define date_start and date_end
	...
	if (empty($q)) {
		if (GETPOSTINT("month")) {
			...
			$date_start = dol_get_first_day($year_start, !getDolGlobalInt('SOCIETE_FISCAL_MONTH_START') ? 1 : $config->global->SOCIETE_FISCAL_MONTH_START, false);
...
//$modetax = $config->global->TAX_MODE;
