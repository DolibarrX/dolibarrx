...
$diroutputmassaction = $config->facture->multidir_output[$config->entity].'/temp/massgeneration/'.$user->id;
...
if ($id > 0 || !empty($ref)) {
	$upload_dir = $config->facture->multidir_output[!empty($object->entity) ? $object->entity : $config->entity]."/".$object->id;
}
