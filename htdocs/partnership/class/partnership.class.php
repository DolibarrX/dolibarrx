...
class Partnership extends CommonObject
{
	...
	public $fields = array(
		...
		'fk_soc' => array('type' => 'integer:Societe:societe/class/societe.class.php:1:((status:=:1) AND (entity:IN:__SHARED_ENTITIES__))', 'label' => 'ThirdParty', 'picture' => 'company', 'enabled' => 1, 'position' => 50, 'notnull' => -1, 'visible' => 1, 'index' => 1, 'css' => 'maxwidth500', 'csslist' => 'tdoverflowmax125',),
	...
	public function __construct(DoliDB $db)
	{
		...
		if (getDolGlobalString('PARTNERSHIP_IS_MANAGED_FOR') == 'member') {
			$this->fields['fk_member'] = array('type' => 'integer:Member:members/class/member.class.php:1', 'label' => 'Member', 'enabled' => '1', 'position' => 50, 'notnull' => -1, 'visible' => 1, 'index' => 1, 'picture' => 'member', 'css' => 'maxwidth500', 'csslist' => 'tdoverflowmax150');
			unset($this->fields['fk_soc']);
		} else {
			$this->fields['fk_soc'] = array('type' => 'integer:Societe:societe/class/societe.class.php:1:((status:=:1) AND (entity:IN:__SHARED_ENTITIES__))', 'label' => 'ThirdParty', 'enabled' => '1', 'position' => 50, 'notnull' => -1, 'visible' => 1, 'index' => 1, 'picture' => 'company', 'css' => 'maxwidth500', 'csslist' => 'tdoverflowmax150');
	...
	public function getTooltipContentArray($params)
	{
		...
		$datas = [];
		$datas['picture'] = img_picture('', $this->picture).' <u>'.$langs->trans("Partnership").'</u>';
