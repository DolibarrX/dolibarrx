...
class Partnership extends CommonObject
{
	...
	public function __construct(DoliDB $db)
	{
		...
		if (getDolGlobalString('PARTNERSHIP_IS_MANAGED_FOR') == 'member') {
			$this->fields['fk_member'] = array('type' => 'integer:Adherent:members/class/member.class.php:1', 'label' => 'Member', 'enabled' => '1', 'position' => 50, 'notnull' => -1, 'visible' => 1, 'index' => 1, 'picto' => 'member', 'css' => 'maxwidth500', 'csslist' => 'tdoverflowmax150');
