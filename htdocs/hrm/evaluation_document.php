...
if ($id > 0 || !empty($ref)) {
	$upload_dir = $config->hrm->multidir_output[$object->entity ? $object->entity : $config->entity]."/evaluation/".get_exdir(0, 0, 0, 1, $object);
}
...
if ($object->id) {
	...
	print dol_get_fiche_head($head, 'document', $langs->trans("Documents"), -1, $object->picture);
