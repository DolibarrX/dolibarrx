...
print $form->textWithPicture($langs->trans("FreeLegalTextOnContracts"), $langs->trans("AddCRIfTooLong").'<br><br>'.$htmltext, 1, 'help', '', 0, 2, 'tooltiphelp');
print '<br>';
...
print $form->textWithPicture($langs->trans("WatermarkOnDraftContractCards"), $htmltext, 1, 'help', '', 0, 2, 'watermarktooltip').'<br>';
...
if ($config->use_javascript_ajax) {
	print ajax_constantonoff('CONTRACT_ALLOW_ONLINESIGN', [], null, 0, 0, 0, 2, 0, 1, '', '', 'inline-block', 0, $langs->trans("WarningOnlineSignature"));
} else {
...
print '<td class="right">';
print ajax_constantonoff('CONTRACT_ALLOW_EXTERNAL_DOWNLOAD', [], null, 0, 0, 0, 2, 0, 1);
print '</td>';
print '</tr>';
print '</table>';
print '</div>';
