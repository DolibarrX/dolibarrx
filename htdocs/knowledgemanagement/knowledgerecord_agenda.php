...
if ($id > 0 || !empty($ref)) {
	$upload_dir = (!empty($config->knowledgemanagement->multidir_output[$object->entity]) ? $config->knowledgemanagement->multidir_output[$object->entity] : $config->knowledgemanagement->dir_output)."/".$object->id;
}
...
if ($object->id > 0) {
	...
	print dol_get_fiche_head($head, 'agenda', $langs->trans("KnowledgeRecord"), -1, $object->picture);
