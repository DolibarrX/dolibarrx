...
// Draft MyObject
if (!empty($config->knowledgemanagement->enabled) && $user->rights->knowledgemanagement->read)
{
	$langs->load("orders");
...
$NBMAX = (!getDolGlobalString('MAIN_SIZE_SHORTLIST_LIMIT') ? 25 : $config->global->MAIN_SIZE_SHORTLIST_LIMIT);
$max = $NBMAX;
