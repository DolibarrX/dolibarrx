...
if ($id > 0 || !empty($ref)) {
	$upload_dir = $config->knowledgemanagement->multidir_output[$object->entity]."/".$object->id;
}
...
if ($id > 0 || !empty($ref)) {
	...
	print dol_get_fiche_head($head, 'note', $langs->trans("KnowledgeRecord"), -1, $object->picture);
