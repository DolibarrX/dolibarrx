...
class Asset extends CommonObject
{
	 ...
	 *  'isameasure' must be set to 1 or 2 if field can be used for measure. Field type must be summable like integer or double(24,8). Use 1 in most cases, or 2 if you do not want to see the column total into a list (for example for percentage)
	 ...
	 *  'copytoclipboard' is 1 or 2 to allow adding a picture to copy value into clipboard (1=picture after label, 2=picture after value)
	 *
	 ...
	 */
	public function getNomUrl($withPicture = 0, $option = '', $maxlen = 0, $notooltip = 0, $morecss = '', $save_lastsearch_value = -1)
	{
		...
		$label = img_picture('', $this->picture).' <u>'.$langs->trans("Asset").'</u>';
	...
	public function getNextNumRef()
	{
		...
		if (!getDolGlobalString('ASSET_ASSET_ADDON')) {
			$config->global->ASSET_ASSET_ADDON = 'mod_asset_standard';
		}
