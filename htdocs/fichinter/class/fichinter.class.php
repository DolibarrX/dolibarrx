...
class Fichinter extends CommonObject
{
	...
	public function getTooltipContentArray($params)
	{
		...
		$datas = [];
		$datas['picture'] = img_picture('', $this->picture).' <u class="paddingrightonly">'.$langs->trans("ShowIntervention").'</u>';
	 ...
	 *
	 *	@param		int		$withPicture					0=_No picture, 1=Includes the picture in the linkn, 2=Picto only
	 ...
	 */
	public function getNomUrl($withPicture = 0, $option = '', $notooltip = 0, $save_lastsearch_value = -1, $morecss = '')
	{
