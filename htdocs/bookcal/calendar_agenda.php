...
if ($id > 0 || !empty($ref)) {
	$upload_dir = $config->bookcal->multidir_output[!empty($object->entity) ? $object->entity : $config->entity]."/".$object->id;
}
...
if ($object->id > 0) {
	...
	print dol_get_fiche_head($head, 'agenda', $langs->trans("Calendar"), -1, $object->picture);
