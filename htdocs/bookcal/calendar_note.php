...
if ($id > 0 || !empty($ref)) {
	$upload_dir = $config->bookcal->multidir_output[empty($object->entity) ? $config->entity : $object->entity]."/".$object->id;
}
...
if ($id > 0 || !empty($ref)) {
	...
	print dol_get_fiche_head($head, 'note', $langs->trans("Calendar"), -1, $object->picture);
