...
class IntracommReport extends CommonObject
{
	...
	/**
	 * @var string 	String with name of icon for intracommreport. Must be a 'fa-xxx' fontawesome code (or 'fa-xxx_fa_color_size') or 'intracommreport@monmodule' if picture is file 'img/object_intracommreport.png'.
	 */
	public $picture = 'intracommreport';
			...
			while ($res = $this->db->fetch_object($resql)) {
				if ($exporttype == 'des') {
					...
					if (empty($res->fk_pays)) {
						// We do not stop the loop because we want to know all the third parties who do not have an informed country
