...
if ($id > 0 || !empty($ref)) {
	$upload_dir = $config->mymodule->multidir_output[$object->entity ? $object->entity : $config->entity]."/myobject/".get_exdir(0, 0, 0, 1, $object);
}
...
print dol_get_fiche_head($head, 'document', $langs->trans("MyObject"), -1, $object->picture);
