...
class InterfaceMyModuleTriggers extends DolibarrTriggers
{
	...
	public function runTrigger($action, $object, User $user, Translate $langs, Config $config)
	{
		...
		// For example : COMPANY_CREATE => public function companyCreate($action, $object, User $user, Translate $langs, Config $config)
		...
		if (is_callable($callback)) {
			...
			return call_user_func($callback, $action, $object, $user, $langs, $config);
		}
