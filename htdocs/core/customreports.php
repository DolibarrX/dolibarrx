...
$arrayoftype = array(
	...
	'invoice' => array('langs' => 'invoice', 'label' => 'Invoices', 'picture' => 'bill', 'ObjectClassName' => 'Invoice', 'enabled' => isModEnabled('invoice'), 'ClassPath' => "/compta/invoice/class/invoice.class.php"),
	'invoice_template' => array('label' => 'PredefinedInvoices', 'picture' => 'bill', 'ObjectClassName' => 'InvoiceRec', 'enabled' => isModEnabled('invoice'), 'ClassPath' => "/compta/class/invoicerec.class.php", 'langs' => 'bills'),
	'contract' => array('label' => 'Contracts', 'picture' => 'contract', 'ObjectClassName' => 'Contract', 'enabled' => isModEnabled('contract'), 'ClassPath' => "/contract/class/contract.class.php", 'langs' => 'contracts'),
	'contractdet' => array('label' => 'ContractLines', 'picture' => 'contract', 'ObjectClassName' => 'ContractLine', 'enabled' => isModEnabled('contract'), 'ClassPath' => "/contract/class/contract.class.php", 'langs' => 'contracts'),
