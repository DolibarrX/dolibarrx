	...
	public function loadBox($max = 5)
	{
		...
		if (empty($user->socid) && !getDolGlobalString('MAIN_DISABLE_GLOBAL_BOXSTATS')) {
			...
			$conditions = array(
				...
				'orders' => isModEnabled('order') && $user->hasRight('order', 'lire'),
				'invoices' => isModEnabled('invoice') && $user->hasRight('invoice', 'lire'),
				'donations' => isModEnabled('donation') && $user->hasRight('donation', 'lire'),
				'contracts' => isModEnabled('contract') && $user->hasRight('contract', 'lire'),
				'interventions' => isModEnabled('intervention') && $user->hasRight('ficheinter', 'lire'),
				'supplier_orders' => isModEnabled('supplier_order') && $user->hasRight('fournisseur', 'order', 'lire') && !getDolGlobalString('SOCIETE_DISABLE_SUPPLIERS_ORDERS_STATS'),
				'supplier_invoices' => isModEnabled('supplier_invoice') && $user->hasRight('fournisseur', 'invoice', 'lire') && !getDolGlobalString('SOCIETE_DISABLE_SUPPLIERS_INVOICES_STATS'),
			...
			$classes = array(
				...
				'supplier_orders' => 'OrderFournisseur',
				'supplier_invoices' => 'InvoiceSupplier',
			...
			$includes = array(
				...
				'orders' => DOL_DOCUMENT_ROOT . "/order/class/order.class.php",
				'invoices' => DOL_DOCUMENT_ROOT . "/compta/invoice/class/invoice.class.php",
				'donations' => DOL_DOCUMENT_ROOT . "/donation/class/don.class.php",
				'contracts' => DOL_DOCUMENT_ROOT . "/contract/class/contract.class.php",
				'interventions' => DOL_DOCUMENT_ROOT . "/fichinter/class/fichinter.class.php",
				'supplier_orders' => DOL_DOCUMENT_ROOT . "/fourn/class/fournisseur.order.class.php",
				'supplier_invoices' => DOL_DOCUMENT_ROOT . "/fourn/class/fournisseur.invoice.class.php",
			...
			$links = array(
				...
				'members' => DOL_URL_ROOT . '/members/list.php?statut=1&mainmenu=members',
				...
				'orders' => DOL_URL_ROOT . '/order/list.php?mainmenu=commercial&leftmenu=orders',
				'invoices' => DOL_URL_ROOT . '/compta/invoice/list.php?mainmenu=billing&leftmenu=customers_bills',
				'donations' => DOL_URL_ROOT . '/donation/list.php?leftmenu=donations',
				'contracts' => DOL_URL_ROOT . '/contract/list.php?mainmenu=commercial&leftmenu=contracts',
				'interventions' => DOL_URL_ROOT . '/fichinter/list.php?mainmenu=commercial&leftmenu=ficheinter',
				'supplier_orders' => DOL_URL_ROOT . '/fourn/order/list.php?mainmenu=commercial&leftmenu=orders_suppliers',
				'supplier_invoices' => DOL_URL_ROOT . '/fourn/invoice/list.php?mainmenu=billing&leftmenu=suppliers_bills',
