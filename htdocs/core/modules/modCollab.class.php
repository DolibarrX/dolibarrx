...
class modCollab extends DolibarrModules
{
	...
	public function __construct($db)
	{
		...
		$this->menu[$r] = array(
			...
			'position' => 100,
			'enabled' => 'isModEnabled("collab")', // Define condition to show or hide menu entry. Use '$config->mymodule->enabled' if entry must be visible if module is enabled. Use '$leftmenu==\'system\'' to show if leftmenu system is selected.
