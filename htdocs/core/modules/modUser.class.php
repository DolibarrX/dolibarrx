...
class modUser extends DolibarrModules
{
	...
	public function __construct($db)
	{
		...
		// Add extra fields
		$sql = "SELECT name, label, fieldrequired FROM ".MAIN_DB_PREFIX."extrafields WHERE type <> 'separate' AND elementtype = 'user' AND entity IN (0,".$config->entity.")";
