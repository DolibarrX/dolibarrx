...
class mod_mo_advanced extends ModeleNumRefMos
{
	...
	public function info($langs)
	{
		...
		$text .= '<td class="right">'.$form->textWithPicture('<input type="text" class="flat minwidth175" name="maskMo" value="'.getDolGlobalString('MRP_MO_ADVANCED_MASK').'">', $tooltip, 1, 'help', 'valignmiddle', 0, 3, $this->name).'</td>';
