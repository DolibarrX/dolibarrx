...
class modAccounting extends DolibarrModules
{
	...
	public function __construct($db)
	{
		...
		// Config pages
		$this->configPageUrl = array('accounting.php?mainmenu=accountancy&leftmenu=accountancy_admin');

		// Dependencies
		$this->depends = array("modInvoice", "modBank", "modTax"); // List of modules id that must be enabled if this module is enabled
		...
		$this->needDolibarrVersion = array(3, 9); // Minimum version of Dolibarr required by module
