...
class modAsset extends DolibarrModules
{
	...
	public function __construct($db)
	{
		...
		$this->number = 51000; // TODO Go on page https://wiki.dolibarr.org/index.php/List_of_modules_id to reserve id number for your module
		...
		if (!isModEnabled('asset')) {
			$config->asset = new stdClass();
			$config->asset->enabled = 0;
		}
