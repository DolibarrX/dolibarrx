...
class DolibarrModules // Can not be abstract, because we need to instantiate it into unActivateModule to be able to disable a module whose files were removed.
{
	 ...
	 * 				Another example : array('always'=>array("modBank", "modInvoice", "modProduct", "modCategory"), 'FR'=>array('modBlockedLog'));
	 * Note: Example in modTakePos:  array('always'=>array("modBank", "modInvoice", "modProduct", "modCategory"), 'FR'=>array('modBlockedLog'));
	 *       Example in modAccounting: array("modInvoice", "modBank", "modTax");
