 ...
 * \brief      Fichier contenant la class du modele de numbertation de reference de note de frais Sand
 */
...
class mod_expensereport_sand extends ModeleNumRefExpenseReport
{
	...
	public function info($langs)
	{
		...
		$texte .= '<td class="right">'.$form->textWithPicture('<input type="text" class="flat minwidth175" name="maskvalue" value="'.$mask.'">', $tooltip, 1, 'help', 'valignmiddle', 0, 3, $this->name).'</td>';
