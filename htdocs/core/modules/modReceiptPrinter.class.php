...
class modReceiptPrinter extends DolibarrModules
{
	...
	public function __construct($db)
	{
		...
		$this->needDolibarrVersion = array(3, 9, -2); // Minimum version of Dolibarr required by module
		$this->conflictWith = [];
		...
		//                        'position'=>300,
		//                        'enabled'=>'$config->printing->enabled && preg_match(\'/^(admintools|all)/\',$leftmenu)',
