...
/**
 *	\file       htdocs/core/modules/order/doc/pdf_eratosthene.modules.php
 *	\ingroup    order
 ...
 */
class pdf_eratosthene extends ModelePDFOrders
{
	/**
	 ...
	 *
	 *  @param		Order	$object				Object to generate
	...
	{
		// phpcs:enable
		global $config, $langs, $hookManager, $mysoc;
	 ...
	 *
	 *   	@param	Order		$object    		common object
