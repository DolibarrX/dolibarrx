 ...
 *	\ingroup    project
 *	\brief      Fichier contenant la class du modele de numbertation de reference de projet Universal
 */
...
/**
 * 	Class du modele de numbertation de reference de projet Universal
 */
class mod_task_universal extends ModeleNumRefTask
{
	...
	public function info($langs)
	{
		...
		$texte .= '<td class="right">'.$form->textWithPicture('<input type="text" class="flat minwidth175" name="masktask" value="'.getDolGlobalString('PROJECT_TASK_UNIVERSAL_MASK').'">', $tooltip, 1, 'help', 'valignmiddle', 0, 3, $this->name).'</td>';
