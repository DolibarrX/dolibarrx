...
class modDataPolicy extends DolibarrModules
{
	...
	public function __construct($db)
	{
		...
		$this->rightsClass = 'datapolicy';

		// Family can be 'base' (core modules),'crm','financial','hr','projects','products','ecm','technic' (transverse modules),'interface' (link with external tools),'other','...'
		// It is used to group modules by family in module setup page
		$this->family = "technic";
		// Module position in the family on 2 digits ('01', '10', '20', ...)
		$this->modulePosition = '78';
		...
		$this->needDolibarrVersion = array(7, 0); // Minimum version of Dolibarr required by module
	...
	public function init($options = '')
	{
		...
		$result1 = $extrafields->addExtraField('datapolicy_date', $langs->trans("DATAPOLICY_date"), 'date', 104, 3, 'member', 0, 0, '', '', 1, '', '3', 0);
