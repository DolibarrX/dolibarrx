...
class mod_propale_saphir extends ModeleNumRefPropales
{
	...
	public function info($langs)
	{
		...
		$mask = !getDolGlobalString('PROPALE_SAPHIR_MASK') ? '' : $config->global->PROPALE_SAPHIR_MASK;
		$texte .= '<td class="right">'.$form->textWithPicture('<input type="text" class="flat minwidth175" name="maskpropal" value="'.$mask.'">', $tooltip, 1, 'help', 'valignmiddle', 0, 3, $this->name).'</td>';
