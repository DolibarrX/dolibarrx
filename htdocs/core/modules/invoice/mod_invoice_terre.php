...
/**
 *  \file       htdocs/core/modules/invoice/mod_invoice_terre.php
 *  \ingroup    invoice
...
/**
 *  \class      mod_invoice_terre
 *  \brief      Class of numbering module Terre for invoices
 */
class mod_invoice_terre extends ModeleNumRefInvoices
{
	/**
	 ...
	 * ALTER TABLE llx_invoice ADD COLUMN calculated_numrefonly INTEGER AS (CASE SUBSTRING(ref FROM 1 FOR 2) WHEN 'FA' THEN CAST(SUBSTRING(ref FROM 10) AS SIGNED) ELSE 0 END) PERSISTENT;
