...
/**
 *	\file       htdocs/core/modules/invoice/modules_invoice.php
 *	\ingroup    invoice
 ...
 */
abstract class ModelePDFInvoices extends CommonDocGenerator
{
	public $posxpicture;
	public $posxtva;
	public $posxup;
	 ...
	 */
	private function getSwissQrBill(Invoice $object, Translate $langs)
	{
		global $config;
	 ...
	 */
	protected function getHeightForQRInvoice(int $pagenbr, Invoice $object, Translate $langs)
	{
		if (getDolGlobalString('INVOICE_ADD_SWISS_QR_CODE') == 'bottom') {
	 ...
	 */
	public function addBottomQRInvoice(TCPDF $pdf, Invoice $object, Translate $langs): bool
	{
 ...
 */
abstract class ModeleNumRefInvoices extends CommonNumRefGenerator
{
	/**
