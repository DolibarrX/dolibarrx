...
class modSociete extends DolibarrModules
{
	...
	public function __construct($db)
	{
		...
		$this->requiredBy = array("modExpedition", "modFacture", "modFournisseur", "modFicheinter", "modPropale", "modContract", "modOrder"); // List of module ids to disable if this one is disabled
