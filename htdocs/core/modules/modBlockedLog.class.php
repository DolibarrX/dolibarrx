...
class modBlockedLog extends DolibarrModules
{
	...
	public function __construct($db)
	{
		...
		// Config pages
		//-------------
		$this->configPageUrl = array('blockedlog.php?withtab=1@blockedlog');

		// Dependencies
		//-------------
		$this->hidden = false; // A condition to disable module
		$this->depends = array('always'=>'modInvoice'); // List of modules id that must be enabled if this module is enabled
