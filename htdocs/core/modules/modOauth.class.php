...
class modOauth extends DolibarrModules
{
	...
	public function __construct($db)
	{
		...
		// Config pages
		$this->configPageUrl = array("oauth.php");
		...
		$this->needDolibarrVersion = array(3, 7, -2); // Minimum version of Dolibarr required by module
		$this->conflictWith = [];
		...
		//                        'position'=>300,
		//                        'enabled'=>'$config->oauth->enabled && preg_match(\'/^(admintools|all)/\',$leftmenu)',
