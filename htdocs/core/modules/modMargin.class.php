...
class modMargin extends DolibarrModules
{
	...
	public function __construct($db)
	{
		...
		$this->rightsClass = 'margins';

		// Family can be 'crm','financial','hr','projects','products','ecm','technic','other'
		// It is used to group modules in module setup page
		$this->family = "financial";
		$this->modulePosition = '55';
		...
		$this->needDolibarrVersion = array(3, 2); // Minimum version of Dolibarr required by module
		...
		$this->menu[$r] = array(
			...
			'position' => 100,
			'enabled' => 'isModEnabled("margin")', // Define condition to show or hide menu entry. Use '$config->monmodule->enabled' if entry must be visible if module is enabled.
