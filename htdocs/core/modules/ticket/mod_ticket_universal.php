...
class mod_ticket_universal extends ModeleNumRefTicket
{
	...
	public function info($langs)
	{
		...
		$text .= '<td class="right">'.$form->textWithPicture('<input type="text" class="flat minwidth175" name="maskticket" value="'.getDolGlobalString("TICKET_UNIVERSAL_MASK").'">', $tooltip, 1, 'help', 'valignmiddle', 0, 3, $this->name).'</td>';
