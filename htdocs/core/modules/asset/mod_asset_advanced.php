...
class mod_asset_advanced extends ModeleNumRefAsset
{
	...
	public function info($langs)
	{
		...
		$text .= '<td class="right">'.$form->textWithPicture('<input type="text" class="flat minwidth175" name="mask" value="'.getDolGlobalString('ASSET_ADVANCED_MASK').'">', $tooltip, 1, 'help', 'valignmiddle', 0, 3, $this->name).'</td>';
