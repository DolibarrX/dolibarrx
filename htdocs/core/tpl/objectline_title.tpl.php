...
if (in_array($object->element, array('propal', 'order', 'invoice', 'order_supplier', 'invoice_supplier')) && defined($constant) && $object->status == constant($constant)) {
...
if (in_array($object->element, array('propal', 'order', 'invoice', 'supplier_proposal', 'order_supplier', 'invoice_supplier')) && $object->status == $object::STATUS_DRAFT) {
	global $mysoc;
...
// @phan-suppress-next-line PhanUndeclaredConstantOfClass
if (in_array($object->element, array('propal', 'order', 'invoice')) && $object->status == $object::STATUS_DRAFT) {
	global $mysoc;
