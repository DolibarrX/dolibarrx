...
if ($permtoadd) {
	...
	print img_picture('', 'folder-plus', '', 0, 0, 0, '', 'size15x marginrightonly');
	print '</a>';
} else {
	print '<a id="acreatedir" href="#" class="inline-block valignmiddle toolbarbutton paddingtop" title="'.$langs->trans("NotAllowed").'">';
	print img_picture('', 'folder-plus', 'disabled', 0, 0, 0, '', 'size15x marginrightonly');
	print '</a>';
}
if ($module == 'ecm') {
	...
	print img_picture('', 'refresh', 'id="refreshbutton"', 0, 0, 0, '', 'size15x marginrightonly');
	print '</a>';
}
if ($permtoadd && GETPOSTISSET('website')) {	// If on file manager to manage medias of a web site
	...
	print img_picture('', 'images', '', 0, 0, 0, '', 'size15x flip marginrightonly');
	print '</a>';
