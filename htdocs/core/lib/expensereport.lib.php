...
function expensereport_prepare_head($object)
{
	...
	complete_head_from_modules($config, $langs, $object, $head, $h, 'expensereport', 'add', 'external');

	complete_head_from_modules($config, $langs, $object, $head, $h, 'expensereport', 'remove');
...
function payment_expensereport_prepare_head(PaymentExpenseReport $object)
{
	...
	complete_head_from_modules($config, $langs, $object, $head, $h, 'payment_expensereport', 'remove');
...
function expensereport_admin_prepare_head()
{
	...
	*/
	...
	complete_head_from_modules($config, $langs, null, $head, $h, 'expensereport_admin', 'remove');
