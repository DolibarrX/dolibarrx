 ...
 *		@param 	float	$txtva                      0=do not apply VAT tax, VAT rate=apply (this is VAT rate only without text code, we do not need text code because we already have all tax info into $localtaxes_array)
