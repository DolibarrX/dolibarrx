...
function print_actions_filter(
	...
	print img_picture($langs->trans("ActionType"), 'square', 'class="picturefixedwidth inline-block" style="color: #ddd;"');
	...
	if ($canedit) {
		// Assigned to user
		print '<div class="divsearchfield">';
		print img_picture($langs->trans("ActionsToDoBy"), 'user', 'class="picturefixedwidth inline-block"');
		...
		if (isModEnabled('resource')) {
			...
			// Resource
			print '<div class="divsearchfield">';
			print img_picture($langs->trans("Resource"), 'object_resource', 'class="picturefixedwidth inline-block"');
	...
	if (isModEnabled('project') && $user->hasRight('projet', 'lire')) {
		...
		print '<div class="divsearchfield">';
		print img_picture($langs->trans("Project"), 'project', 'class="picturefixedwidth inline-block"');
	...
	if (isModEnabled('category') && $user->hasRight('category', 'lire')) {
		...
		print '<div class="divsearchfield">';
		print img_picture($langs->trans('Categories'), 'category', 'class="picturefixedwidth"');
	...
	if ($canedit && !preg_match('/list/', $_SERVER["PHP_SELF"])) {
		// Status
		print '<div class="divsearchfield">';
		print img_picture($langs->trans("Status"), 'status', 'class="picturefixedwidth inline-block"');
...
function actions_prepare_head($object)
{
	...
	$upload_dir = $config->agenda->dir_output . "/" . $object->id;
