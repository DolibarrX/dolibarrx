...
if (GETPOST('removedfile') && !GETPOST('removAll')) {
	...
	dol_remove_file_process(GETPOST('removedfile', 'alpha'), 0, 1, $trackid); // We do not delete because if file is the official PDF of doc, we do not want to remove it physically
	$action = 'presend';
}
