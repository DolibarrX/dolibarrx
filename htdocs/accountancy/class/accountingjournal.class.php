...
class AccountingJournal extends CommonObject
{
	 ...
	 * @return	int<-1,-1>|array<int,array{ref:string,error:?string,blocks:array<array<array{date:string,piece:string,account_accounting:string,subledger_account:string,label_operation:string,debit:string,credit:string}|array{doc_date:''|int,date_lim_reglement:string,doc_ref:string,date_creation:int,doc_type:string,fk_doc:int|string,fk_docdet:int|string,thirdparty_code:string,subledger_account:string,subledger_label:string,number_compte:string,label_compte:string,label_operation:string,montant:string,sens:string,debit:int|float|string,credit:int|float|string,code_journal:string,journal_label:string,piece_num:string,import_key:string,fk_user_author:string,entity:string}>>}>	Return integer <0 if KO, array
	 */
	 ...
	 * @param	array<int,array{ref?:string,error?:string,blocks:array<array<array{doc_date:int|string,date_lim_reglement:int|string,doc_ref:string,date_creation:int,doc_type:string,fk_doc:int|string,fk_docdet:int|string,thirdparty_code:string,subledger_account:string,subledger_label:string,number_compte:string,label_compte:string,label_operation:string,montant:float|string,sens:string,debit:int|float|string,credit:int|float|string,code_journal:string,journal_label:string,piece_num:int|string,import_key:string,fk_user_author:string,entity:string}>>}>	$journal_data		Journal data to write in the bookkeeping
	 *                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              $journal_data = array(
	 *                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              .	id_element => array(
	 *                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              .		'ref' => 'ref',
	 *                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              .		'error' => '',
				...
				if (!$error_for_line) {
					foreach ($element['blocks'] as $lines) {
						foreach ($lines as $line) {
							...
							$bookkeeping->number_compte = $line['number_compte'];
