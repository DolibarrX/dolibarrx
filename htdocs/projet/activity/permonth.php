...
print dol_get_fiche_head($head, 'inputpermonth', $langs->trans('TimeSpent'), -1, $picture);
...
if (!empty($arrayfields['t.planned_workload']['checked'])) {
	print '<td align="right" class="leftborder plannedworkload maxwidth75">'.$form->textWithPicture($langs->trans("PlannedWorkloadShort"), $langs->trans("PlannedWorkload")).'</td>';
}
if (!empty($arrayfields['t.progress']['checked'])) {
