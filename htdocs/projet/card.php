			...
			*/
			...
			if (!getDolGlobalString('PROJECT_HIDE_CREATE_OBJECT_BUTTON')) {
				$arrayforbutaction = array(
					...
					20 => array('lang' => 'orders', 'enabled' => isModEnabled("order"), 'perm' => $user->hasRight('order', 'creer') ? true : false, 'label' => 'CreateOrder', 'url' => '/order/card.php?action=create&amp;projectid='.$object->id.'&amp;socid='.$object->socid),
					30 => array('lang' => 'bills', 'enabled' => isModEnabled("invoice"), 'perm' => $user->hasRight('invoice', 'creer') ? true : false, 'label' => 'CreateBill', 'url' => '/compta/invoice/card.php?action=create&amp;projectid='.$object->id.'&amp;socid='.$object->socid),
					...
					50 => array('lang' => 'suppliers', 'enabled' => isModEnabled("supplier_order"), 'perm' => $user->hasRight('fournisseur', 'order', 'creer') ? true : false, 'label' => 'AddSupplierOrder', 'url' => '/fourn/order/card.php?action=create&amp;projectid='.$object->id.'&amp;socid='.$object->socid),
					60 => array('lang' => 'suppliers', 'enabled' => isModEnabled("supplier_invoice"), 'perm' => $user->hasRight('fournisseur', 'invoice', 'creer') ? true : false, 'label' => 'AddSupplierInvoice', 'url' => '/fourn/invoice/card.php?action=create&amp;projectid='.$object->id.'&amp;socid='.$object->socid),
