...
echo "<!-- BEGIN PHP TEMPLATE members/tpl/linkedobjectblock.tpl.php -->\n";
...
foreach ($linkedObjectBlock as $key => $objectlink) {
	...
	echo '<td class="right"><a class="reposition" href="'.$_SERVER["PHP_SELF"].'?id='.$object->id.'&action=dellink&token='.newToken().'&dellinkid='.$key.'">'.img_picture($langs->transnoentitiesnoconv("RemoveLink"), 'unlink').'</a></td>';
	echo '</tr>';
}
