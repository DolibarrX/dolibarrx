...
if ($id > 0 || !empty($ref)) {
	$upload_dir = $config->recruitment->multidir_output[$object->entity ? $object->entity : $config->entity]."/recruitmentjobposition/".get_exdir(0, 0, 0, 1, $object);
}
...
if ($object->id) {
	...
	print dol_get_fiche_head($head, 'document', $langs->trans("RecruitmentJobPosition"), -1, $object->picture);
