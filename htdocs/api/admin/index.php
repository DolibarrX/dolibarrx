...
print '<tr class="oddeven">';
print '<td>'.$form->textWithPicture($langs->trans("RESTRICT_ON_IP"), $langs->trans("Example").': '.$langs->trans("IPListExample"));
print '</td>';
...
$message .= '<div class="urllink soixantepercent">'.img_picture('', 'globe').' <input type="text" class="quatrevingtpercent" id="urltogettoken" value="'.$url.'"></div>';
print $message;
...
if (dol_is_dir(DOL_DOCUMENT_ROOT.'/includes/restler/framework/Luracast/Restler/explorer')) {
	...
	print '<div class="urllink soixantepercent">'.img_picture('', 'globe').' <a href="'.$url.'" target="_blank" rel="noopener noreferrer">'.$url."</a></div><br>\n";
	...
	print '<div class="urllink soixantepercent">'.img_picture('', 'globe').' <input type="text" class="quatrevingtpercent" id="urltogetapidesc" value="'.$urlswagger.'"></div>';
	print '</div>';
