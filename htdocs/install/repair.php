...
if ($dolibarr_main_db_character_set != 'utf8mb4') {
	print '<img src="../theme/eldy/img/warning.png" class="picturefortooltip valignmiddle" title="If you switch to utf8mb4, you must also check the value for $dolibarr_main_db_character_set and $dolibarr_main_db_collation into conf/conf.php file.">';
}
print "<br>\n";
...
if ($ok && GETPOST('standard', 'alpha')) {
	...
	$listofmodulesextra = array('societe' => 'societe', 'member' => 'member', 'product' => 'product',
				...
				'member_type' => 'member_type', 'user' => 'user', 'partnership' => 'partnership', 'projet' => 'projet', 'projet_task' => 'projet_task', 'ticket' => 'ticket');
