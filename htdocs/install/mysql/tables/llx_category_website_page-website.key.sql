...
ALTER TABLE llx_category_website_page ADD CONSTRAINT fk_category_websitepage_category_rowid FOREIGN KEY (fk_category) REFERENCES llx_category (rowid);
ALTER TABLE llx_category_website_page ADD CONSTRAINT fk_category_websitepage_website_page_rowid FOREIGN KEY (fk_website_page) REFERENCES llx_website_page (rowid);
