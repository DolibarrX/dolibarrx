...
ALTER TABLE llx_category_fournisseur ADD PRIMARY KEY pk_category_fournisseur (fk_category, fk_soc);
ALTER TABLE llx_category_fournisseur ADD INDEX idx_category_fournisseur_fk_category (fk_category);
ALTER TABLE llx_category_fournisseur ADD INDEX idx_category_fournisseur_fk_societe (fk_soc);
