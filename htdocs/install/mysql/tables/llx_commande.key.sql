...
-- Delete orphans
-- V4 DELETE llx_order FROM llx_order LEFT JOIN llx_societe ON llx_order.fk_soc = llx_societe.rowid WHERE llx_societe.rowid IS NULL; 

ALTER TABLE llx_order ADD UNIQUE INDEX uk_order_ref (ref, entity);

ALTER TABLE llx_order ADD INDEX idx_order_fk_soc (fk_soc);
...
ALTER TABLE llx_order ADD CONSTRAINT fk_order_fk_soc			FOREIGN KEY (fk_soc) REFERENCES llx_societe (rowid);
