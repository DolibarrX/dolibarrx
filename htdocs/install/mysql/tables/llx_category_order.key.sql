...
ALTER TABLE llx_category_order ADD PRIMARY KEY pk_category_order (fk_category, fk_order);
ALTER TABLE llx_category_order ADD INDEX idx_category_order_fk_category (fk_category);
