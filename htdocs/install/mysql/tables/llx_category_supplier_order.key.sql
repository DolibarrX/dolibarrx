...
ALTER TABLE llx_category_supplier_order ADD PRIMARY KEY pk_category_supplier_order (fk_category, fk_supplier_order);
ALTER TABLE llx_category_supplier_order ADD INDEX idx_category_supplier_order_fk_category (fk_category);
