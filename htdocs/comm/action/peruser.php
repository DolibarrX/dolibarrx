...
$sql .= " ca.code, ca.libelle as type_label, ca.color, ca.type as type_type, ca.picture as type_picture";
...
while ($currentdaytoshow < $lastdaytoshow) {
	...
	if ($canedit && $mode == 'show_peruser') {
		...
		print img_picture('', 'clock', 'class="fawidth30 inline-block marginleftonly"');
