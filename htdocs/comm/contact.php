...
if ($resql) {
	...
	print '<td class="liste_titre right"><input type="image" class="liste_titre" src="'.img_picture($langs->trans("Search"), 'search.png', '', 0, 1).'" value="'.dol_escape_htmltag($langs->trans("Search")).'" title="'.dol_escape_htmltag($langs->trans("Search")).'"></td>';
	print "</tr>\n";
